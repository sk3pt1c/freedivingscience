...
The authors describe three main outcomes when pressure stress overwhelms the chest–lung system:
1) partial lung collapse (atelectasis),
2) fluid leaking into air spaces (pulmonary edema),
3) rupture/bleeding across the membrane (alveolar hemorrhage → blood/cough).
...
[Download PDF](../pdfs/The physiology and pathophysiology of human breath hold diving.pdf)
