...
The researchers used computer simulations (computational fluid dynamics) with a full 3D model of a swimmer and compared two common underwater gliding positions:
1) **Streamlined**: ventral (face down) with **arms extended forward**.
2) **Arms by the sides**: ventral with **arms along the trunk**.
...
They also broke drag into two main parts:
- **Pressure drag** (the “wall of water” effect from shape and flow separation).
- **Skin friction drag** (water rubbing along the surface).
...
[Download PDF](../pdfs/swimmer drag research.pdf)
