...
Greyson started with a large pool of reported NDE features gathered from previous literature and early questionnaires, then refined them into a **16-item scale** that covers four clusters:
- **Cognitive** (e.g., changes in time perception, unusually fast or clear thinking, life review),
- **Affective** (e.g., peace, joy, sense of harmony or unity),
- **Paranormal** (e.g., heightened senses, extrasensory-type impressions),
- **Transcendental** (e.g., encountering an “other realm,” a mystical presence, or a boundary and return).
...
[Download PDF](../pdfs/Near Dear Experience Scale.pdf)
