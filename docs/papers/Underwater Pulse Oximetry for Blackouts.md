...
source: https://doi.org/10.3389/fphys.2021.651128
date: 01 April 2021
tags:
  - level-intermediate
  - pulse-oximetry
...
But deep dives had much more “shape” to them, and the phase breakdown is super useful for coaching:
- HR dropped during the descent, and **dropped again during free-fall** (when effort is low).
- HR rose during the hard-working part of the ascent (when the diver is swimming strongly against negative buoyancy).
- HR dipped again when buoyancy helped near the end.
...
[Download PDF](../pdfs/Underwater Pulse Oximetry for Blackouts.pdf)
