...
From there, the review outlines how brainstem circuits appear to coordinate the three main outputs:
- **Apnea:** diving animals remain apneic even with extreme low O₂ and high CO₂—meaning the normal “breathe now!” chemoreflex is being overridden.
- **Bradycardia:** largely driven by the vagus nerve via cardiac control regions near the nucleus ambiguus.
- **Vasoconstriction / blood pressure control:** driven by sympathetic output, involving brainstem regions like the rostral ventrolateral medulla (RVLM), with selective blood flow reduction to limbs/skin/splanchnic areas while protecting flow to the brain and heart.
...
[Download PDF](../pdfs/mammalian diving response.pdf)
